...
- frontend와 backend 멀티 모듈 프로젝트로 구성
- frontend는 vue.js의 강좌 단계별 로그인 예제
- backend는 SpringBoot 3.x 버전의 Spring Security를 적용하여 OAuth와 소셜 로그인 예제를
  Step by Step으로 따라하기 강의가 이루어짐
- 각 Branch 를 통해 로그인, 회원 가입, 로그아웃, 소셜 로그인등의 이해를 할 수 있음
- 